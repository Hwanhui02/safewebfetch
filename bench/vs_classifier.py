...
import indirect_cases as dev, indirect_holdout as ho, indirect_holdout2 as ho2, indirect_codex as cx, indirect_codex2 as cx2, indirect_codex3 as cx3, indirect_codex4 as cx4, indirect_codex5 as cx5
...
for label, mod in [("dev", dev), ("holdout", ho), ("holdout2", ho2), ("codex", cx), ("codex2", cx2), ("codex3", cx3), ("codex4", cx4), ("codex5", cx5)]:
