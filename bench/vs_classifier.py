...
import indirect_cases as dev, indirect_holdout as ho, indirect_holdout2 as ho2, indirect_codex as cx
...
for label, mod in [("dev", dev), ("holdout", ho), ("holdout2", ho2), ("codex", cx)]:
